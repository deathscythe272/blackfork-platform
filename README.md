...
- [ ] Gatehouse: judge lane (G2, advisory, running on every PR) + ADR-005 + planted-flaw
      precision per rubric item ([docs/analysis/judge-precision.md](docs/analysis/judge-precision.md));
      seeded injection evals next (G3+)

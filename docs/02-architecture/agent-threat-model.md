...
| T1-CI-01 to T1-CI-04 | B8 | `infra/modules/delivery-plane/`, `.github/workflows/terraform.yml` | Two passing, two planned |

Count: 39 threat rows, 20 passing, 1 measured with mitigation upstream, 13 planned with a phase, 5 gaps named. The gaps are

...
| ADR | Decision | Serves |
|---|---|---|
| 001 | Custom auth/audit gateway in front of the MCP server | BR-7 |
| 002 | Iceberg lakehouse (bronze/silver/gold) over proprietary warehouse | BR-2, C4 |
| 003 | MCP as the sole data path; parameterized tools, no model-written SQL | BR-7 |
| 004 | Four narrow agents; Risk Analyst isolated behind A2A | BR-3 |
| 005 | Gatehouse two lanes; advisory→blocking promotion by measured precision (incl. fail-open/closed) | BR-3, BR-4 |

...
- Given up: the ability to show a person the original summary through the platform.
  ...
  agent path.
- Over-reach is a failure too. The first full scan erased the product name "Security
  Onion" from two evidence rows as a person's name. An allow list of the platform's

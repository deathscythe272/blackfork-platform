...
3. Done: G3 planted-flaw evals. Nine fixtures (a planted flaw for every rubric item,
   ...
   R2, R3 never fire. Follow-up before step 4: move R1's mechanical checks and R3 to
   Lane 1 as scripts, give R2 parsed diagram facts, cut the R4 cross-item sentence,
   tighten the output format, re-score as rubric v1.1.

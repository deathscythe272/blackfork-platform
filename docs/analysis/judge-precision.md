...
Nothing is promoted. R1 meets every fixture threshold; R5's live count restarted at
zero with this rubric, on the record in the adjustments ledger; both wait on twenty
live instances.
